  ...
  <div class="app-container">
    ...
    <el-card class="table-container" shadow="never">
      ...
      <el-table v-loading="loading" :data="items" element-loading-text="加载中" style="width: 100%" row-key="Id" stripe>
        ...
        <el-table-column prop="Name" label="大类名称" sortable />
    ...
    <div class="form-container">
      <MainCategoryDialog :dialog-visible="dialogVisible" :dialog-type="dialogType" :selected-item="selectedItem" @save="save" @cancel="cancel" />
    </div>
  </div>
</template>

<script>
import { query, get, create, update, del } from '@/api/mainCategory'
import MainCategoryDialog from './MainCategoryDialog.vue'
